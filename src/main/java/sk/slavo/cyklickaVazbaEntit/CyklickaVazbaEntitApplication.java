package sk.slavo.cyklickaVazbaEntit;
...
import sk.slavo.cyklickaVazbaEntit.repo.LocationRepository;
import sk.slavo.cyklickaVazbaEntit.repo.UserRepository;

@SpringBootApplication
public class CyklickaVazbaEntitApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(CyklickaVazbaEntitApplication.class, args);

	}
	
	// oprava 2 cez model mapper
	@Bean
